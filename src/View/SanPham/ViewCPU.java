 ...
 * @author haha
 */
public class ViewCPU extends javax.swing.JDialog {
     ...
     */
    public ViewCPU(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();
    ...
    private void loadx() {
        ...
        String[] title = {"CPU", "GPU", "Loại", "Hãng", "Tiến trình"};
    ...
    private void loadDataToTable(List<Cpu> h) {
        tbl.setRowCount(0);
        for (Cpu x : h) {
            Object[] row = new Object[]{x.getCPU(), x.getGPU(), x.getLoai(), x.getHang(), x.getTienTrinh()};
            tbl.addRow(row);
        }
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(12, 12, 12)
                        .addComponent(cbbTrangThai, 0, 125, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (btnThem.getText() == "Lưu") {
            if (txtGPU.getText().isBlank() || txtCPU.getText().isBlank() || txtHang.getText().isBlank()) {
                System.out.println("them khong dc");
            } else {
                btnThem.setText("Thêm");
                Cpu hdh = new Cpu("", txtCPU.getText(), txtGPU.getText(), txtLoai.getText(), txtHang.getText(), txtTT.getText(), cbbTrangThai.getSelectedIndex());
                JOptionPane.showMessageDialog(this, sps.addCPU(hdh));
                loadDataToTable(sps.getCPU());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (btnSua.getText() == "Lưu") {
            if (txtGPU.getText().isBlank() || txtCPU.getText().isBlank() || txtHang.getText().isBlank()) {
                ...
                btnSua.setText("Sửa");
                Cpu hdh = new Cpu("", txtCPU.getText(), txtGPU.getText(), txtLoai.getText(), txtHang.getText(), txtTT.getText(), cbbTrangThai.getSelectedIndex());
                JOptionPane.showMessageDialog(this, sps.suaCPU(hdh));
                loadDataToTable(sps.getCPU());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewCPU dialog = new ViewCPU(new javax.swing.JFrame(), true, "");
