 ...
 * @author haha
 */
public class CameraView extends javax.swing.JDialog {

    /**
     * Creates new form CameraView
     */
    public CameraView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tblCamera.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tên máy", "Số camera trước", "Số camera Sau"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CameraView dialog = new CameraView(new javax.swing.JFrame(), true);
