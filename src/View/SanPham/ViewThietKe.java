 ...
 * @author haha
 */
public class ViewThietKe extends javax.swing.JDialog {
     ...
     */
    public ViewThietKe(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        initComponents();

        loadx();
        loadDataToTable(sps.getTK());
    ...
    private void loadDataToTable(List<ThietKe> h) {
        tbl.setRowCount(0);
        for (ThietKe x : h) {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(12, 12, 12)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtMS, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                                    .addComponent(txtMT)
    ...
    private void tbl1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl1MouseClicked
        ...
        ThietKe hdh = sps.getTK().get(index);
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (btnThem.getText() == "Lưu") {
            if (txtMS.getText().isBlank() || txtMT.getText().isBlank() || txtVien.getText().isBlank()) {
                System.out.println("them khong dc");
            } else {
                btnThem.setText("Thêm");
                ThietKe hdh = new ThietKe("", txtMT.getText(), txtMS.getText(), txtVien.getText(), txtTrongLuong.getText(), cbbTrangThai.getSelectedIndex());
                JOptionPane.showMessageDialog(this, sps.addTK(hdh));
                loadDataToTable(sps.getTK());
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (btnSua.getText() == "Lưu") {
            if (txtMS.getText().isBlank() || txtMT.getText().isBlank() || txtVien.getText().isBlank()) {
                ...
                btnSua.setText("Sửa");
                ThietKe hdh = new ThietKe(id, txtMT.getText(), txtMS.getText(), txtVien.getText(), txtTrongLuong.getText(), cbbTrangThai.getSelectedIndex());
                JOptionPane.showMessageDialog(this, sps.suaTK(hdh));
                loadDataToTable(sps.getTK());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewThietKe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewThietKe dialog = new ViewThietKe(new javax.swing.JFrame(), true, "");
